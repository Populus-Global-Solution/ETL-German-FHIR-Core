...
ALTER TABLE cdm.care_site ALTER COLUMN care_site_id DROP IDENTITY IF EXISTS;
ALTER TABLE cdm.care_site ALTER COLUMN care_site_id ADD GENERATED BY DEFAULT AS IDENTITY;
